...
- [Open Lowcode](https://github.com/openlowcode/Open-Lowcode) - A low-code framework for enterprise software on PC with a JavaFX thin client [Eclipse Public License v2](http://www.eclipse.org/legal/epl-2.0) 
